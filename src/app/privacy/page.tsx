  ...
  return (
    <PageShell crumbs={[{ name: "Home", path: "/" }, { name: "Privacy", path: "/privacy" }]} title="Privacy Policy" lede="Last updated August 2026.">
      <Prose>
        ...
        <p><strong>AI features.</strong> When you use AI features, prompts are processed server-side via Google Gemini to generate results; we do not sell your data.</p>
