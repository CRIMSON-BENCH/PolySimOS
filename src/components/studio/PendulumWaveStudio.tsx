  ...
  return (
    <StudioChrome title="Pendulum Wave" tagline="phase art from many periods"
      controls={<div>
        ...
        <Slider label="Pendulums" value={n} min={8} max={30} step={1} onChange={setN} />
        <Slider label="Period spread" value={spread} min={1} max={8} step={0.5} onChange={setSpread} />
      </div>}
      inspector={<div><Stat label="Pendulums" value={String(n)} /><Stat label="Effect" value="phase waves" /></div>}
