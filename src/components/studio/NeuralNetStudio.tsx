...
export function NeuralNetStudio() {
  ...
  useEffect(() => {
    ...
    const step = () => {
      const n = net.current!; const H = n.W1.length; const lrr = lr;
      ...
      const canvas = canvasRef.current!; const ctx = canvas.getContext("2d")!; const W = canvas.width, Hh = canvas.height; const R = 60;
      ...
      void R; raf = requestAnimationFrame(step);
    };
